...
int ui_display_multisig_vote(void);
int ui_prepare_multisig_vote(void);

int ui_display_multisig_create_with_owners(void);
int ui_prepare_multisig_create_with_owners(void);
