...
typedef enum {
    ...
    GENERIC_ARG_LEN_READ_ERROR = -40,
    GENERIC_ARG_BYTES_READ_ERROR = -41,
    TYPE_TAG_SKIP_ERROR = -42,
    SCRIPT_CODE_LEN_READ_ERROR = -43,
    SCRIPT_CODE_READ_ERROR = -44,
    SCRIPT_ARG_VARIANT_READ_ERROR = -45,
    SCRIPT_ARG_READ_ERROR = -46,
    MULTISIG_ADDRESS_READ_ERROR = -47,
    MULTISIG_OPTION_READ_ERROR = -48,
